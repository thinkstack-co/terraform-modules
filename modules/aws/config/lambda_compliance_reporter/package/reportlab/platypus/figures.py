...
from reportlab.lib.styles import ParagraphStyle, _baseFontName, _baseFontNameI
...
try:
    from rlextra.pageCatcher.pageCatcher import restoreForms, restoreFormsInMemory, storeForms, storeFormsInMemory
    ...
    class PageCatcherFigure(PageCatcherFigureNonA4):
        ...
        def __init__(self, filename, pageNo, caption, width=595, height=842, background=None, caching=None):
            PageCatcherFigureNonA4.__init__(
                self, filename, pageNo, caption, width, height, background=background, caching=caching
            )
