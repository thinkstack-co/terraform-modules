...
from reportlab.lib.utils import annotateException, decode_label, encode_label, isSeq, strTypes
from reportlab.pdfgen import canvas
from reportlab.platypus.flowables import *
from reportlab.platypus.flowables import _ContainerSpace
from reportlab.platypus.frames import Frame
from reportlab.platypus.paragraph import Paragraph
from reportlab.rl_config import defaultPageSize, invariant, verbose
...
class BaseDocTemplate:
    ...
    def _makeCanvas(self, filename=None, canvasmaker=canvas.Canvas):
        ...
        *NB* only the canvases created in self._startBuild will actually be used
        ...
        from reportlab.pdfbase.pdfdoc import ViewerPreferencesPDFDictionary as VPD
        from reportlab.pdfbase.pdfdoc import checkPDFBoolean as cPDFB
