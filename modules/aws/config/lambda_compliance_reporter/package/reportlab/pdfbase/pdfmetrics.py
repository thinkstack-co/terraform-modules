...
from reportlab.lib.rl_accel import instanceStringWidthT1, unicode2T1
...
from reportlab.pdfbase import _fontdata, rl_codecs
from reportlab.rl_config import T1SearchPath, defaultEncoding
