...
from reportlab.lib.colors import Blacker, CMYKColor, Color, Whiter, opaqueColor
...
class AcroForm(PDFObject):
    ...
    def _textfield(
        ...
        self.checkForceBorder(
            x, y, width, height, forceBorder, "square", borderStyle, borderWidth, borderColor, fillColor
        )
