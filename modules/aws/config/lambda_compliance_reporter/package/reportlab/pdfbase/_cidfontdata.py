...
allowedEncodings = ["Identity-H", "Identity-V"] + encodings_chs + encodings_cht + encodings_jpn + encodings_kor
    ...
    "DescendantFonts": [
        {
            ...
            "W": [
                ...
                36,
                [708, 750, 708, 666, 750, 791, 375, 500, 791, 666, 916, 791, 750, 666, 750, 708, 666, 791],
                54,
                [791, 750, 1000, 708],
                58,
                [708, 666, 500, 375, 500],
