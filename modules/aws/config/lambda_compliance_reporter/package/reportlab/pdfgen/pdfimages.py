...
from reportlab.lib.rl_accel import asciiBase85Encode, fp_str
...
class PDFImage:
    ...
    def drawInlineImage(
        self, canvas, preserveAspectRatio=False, anchor="sw", anchorAtXY=False, showBoundary=False, extraReturn=None
    ):
        ...
        x, y, self.width, self.height, scaled = aspectRatioFix(
            preserveAspectRatio, anchor, self.x, self.y, width, height, self.imgwidth, self.imgheight, anchorAtXY
        )
