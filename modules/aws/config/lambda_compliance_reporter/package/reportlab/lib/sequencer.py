...
def test():
    ...
    print("Counting Figures: Figure %d, Figure %d, Figure %d" % (s.next("figure"), s.next("figure"), s.next("figure")))
    ...
    print("    Appendix %s, Appendix %s, Appendix %s" % (s.nextf("Appendix"), s.nextf("Appendix"), s.nextf("Appendix")))
