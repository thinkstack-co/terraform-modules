...
from reportlab.rl_config import embeddedHyphenation as _embeddedHyphenation
from reportlab.rl_config import hyphenationLang as _hyphenationLang
from reportlab.rl_config import hyphenationMinWordLength as _hyphenationMinWordLength
from reportlab.rl_config import platypus_link_underline as _platypus_link_underline
from reportlab.rl_config import spaceShrinkage as _spaceShrinkage
from reportlab.rl_config import strikeGap as _baseStrikeGap
from reportlab.rl_config import strikeOffset as _baseStrikeOffset
from reportlab.rl_config import strikeWidth as _baseStrikeWidth
from reportlab.rl_config import underlineGap as _baseUnderlineGap
from reportlab.rl_config import underlineOffset as _baseUnderlineOffset
from reportlab.rl_config import underlineWidth as _baseUnderlineWidth
from reportlab.rl_config import uriWasteReduce as _uriWasteReduce
...
def str2alignment(
    v, __map__=dict(centre=TA_CENTER, center=TA_CENTER, left=TA_LEFT, right=TA_RIGHT, justify=TA_JUSTIFY)
):
...
def getSampleStyleSheet():
    ...
    stylesheet.add(
        ParagraphStyle(
            name="Heading1", parent=stylesheet["Normal"], fontName=_baseFontNameB, fontSize=18, leading=22, spaceAfter=6
        ),
        alias="h1",
    )
