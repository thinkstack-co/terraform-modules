...
class DotBox(Widget):
    ...
    _attrMap = AttrMap(
        xlabels=AttrMapValue(isNoneOrListOfNoneOrStrings, desc="List of text labels for boxes on left hand side"),
        ylabels=AttrMapValue(isNoneOrListOfNoneOrStrings, desc="Text label for second box on left hand side"),
