...
from reportlab.graphics.shapes import STATE_DEFAULTS, Circle, DirectDraw, Drawing, Group, Rect, String
...
from reportlab.platypus import Flowable, XPreformatted
...
class Label(Widget):
    ...
    _attrMap = AttrMap(
        ...
        ddf=AttrMapValue(
            NoneOr(isSubclassOf(DirectDraw), "NoneOrDirectDraw"), desc="A DirectDrawFlowable instance", _advancedUsage=1
        ),
