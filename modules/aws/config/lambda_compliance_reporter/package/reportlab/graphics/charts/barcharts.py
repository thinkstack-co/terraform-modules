...
from reportlab.graphics.charts.axes import XCategoryAxis, XValueAxis, YCategoryAxis, YValueAxis
...
class BarChart(PlotArea):
    ...
    _attrMap = AttrMap(
        ...
        barLabelFormat=AttrMapValue(
            None, desc="Formatting string or function used for bar labels. Can be a list or list of lists of such."
        ),
        ...
        barRecord=AttrMapValue(
            None, desc="callable(bar,label=labelText,value=value,**kwds) to record bar information", advancedUsage=1
        ),
    ...
    annotations=7""",
        ...
        categoryNALabel=AttrMapValue(
            NoneOrInstanceOfNA_Label, desc="Label to use for a group of N/A values.", advancedUsage=1
        ),
