...
from reportlab.graphics.barcode import createBarcodeDrawing, createBarcodeImageInMemory, getCodeNames
...
from reportlab.platypus.flowables import KeepTogether, XBox
...
if __name__ == "__main__":
    ...
    createSample(
        "test_cbcim.tiff",
        createBarcodeImageInMemory("USPS_4State", value="01234567094987654321", routing="01234567891", format="tiff"),
    )
    createSample(
        "test_cbcim-1.pdf",
        createBarcodeImageInMemory(
            "QR", value="This is the end my only friend the end at the end of the Universe.", format="pdf"
        ),
    )
