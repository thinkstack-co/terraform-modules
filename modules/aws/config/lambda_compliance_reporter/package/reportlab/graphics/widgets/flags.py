...
class Flag(_Symbol):
    ...
    def _Flag_UK(self):
        ...
        g.add(
            Polygon(
                [0, s - (s / 15.0), (s - ((s / 10.0) * 4)), (s * 0.65), (s - (s / 10.0) * 3), (s * 0.65), 0, s],
        ...
        g.add(
            Polygon(
                [0, 0, (s - ((s / 10.0) * 3)), (s * 0.35), (s - ((s / 10.0) * 2)), (s * 0.35), (s / 10.0), 0],
                fillColor=colors.red,
                strokeColor=None,
                strokeWidth=0,
            )
        ...
        g.add(
            Polygon(
                [w, s, (s + ((s / 10.0) * 3)), (s * 0.65), (s + ((s / 10.0) * 2)), (s * 0.65), w - (s / 10.0), s],
                fillColor=colors.red,
                strokeColor=None,
                strokeWidth=0,
            )
        ...
        g.add(
            Polygon(
                [w, (s / 15.0), (s + ((s / 10.0) * 4)), (s * 0.35), (s + ((s / 10.0) * 3)), (s * 0.35), w, 0],
                fillColor=colors.red,
                strokeColor=None,
                strokeWidth=0,
            )
    ...
    def _Flag_Austria(self):
        ...
        redbox2 = Rect(
            0, ((s / 3.0) * 2.0), width=s * 2.0, height=s / 3.0, fillColor=colors.red, strokeColor=None, strokeWidth=0
        )
        g.add(redbox2)
        return g
    ...
    def _Flag_Cuba(self):
        ...
        redwedge = Polygon(
            points=[0, 0, 4 * s / 5.0, (s / 2.0), 0, s], fillColor=colors.red, strokeColor=None, strokeWidth=0
        )
        g.add(redwedge)
    ...
    def _Flag_Denmark(self):
        ...
        whitebox1 = Rect(
            ((s / 5.0) * 2), 0, width=s / 6.0, height=s, fillColor=colors.mintcream, strokeColor=None, strokeWidth=0
        )
        g.add(whitebox1)
    ...
    def _Flag_Finland(self):
        ...
        blueline1 = Rect(
            (s * 0.6), 0, width=0.3 * s, height=s, fillColor=colors.darkblue, strokeColor=None, strokeWidth=0
        )
        g.add(blueline1)

        blueline2 = Rect(
            0, (s * 0.4), width=s * 2, height=s * 0.3, fillColor=colors.darkblue, strokeColor=None, strokeWidth=0
        )
        g.add(blueline2)
        return g
    ...
    def _Flag_Germany(self):
        ...
        blackbox1 = Rect(
            0, ((s / 3.0) * 2.0), width=s * 2.0, height=s / 3.0, fillColor=colors.black, strokeColor=None, strokeWidth=0
        )
        g.add(blackbox1)

        redbox1 = Rect(
            0, (s / 3.0), width=s * 2.0, height=s / 3.0, fillColor=colors.orangered, strokeColor=None, strokeWidth=0
        )
        g.add(redbox1)
        return g
    ...
    def _Flag_Italy(self):
        ...
        g.add(
            Rect((4 * s) / 3.0, 0, width=(s * 2) / 3.0, height=s, fillColor=colors.red, strokeColor=None, strokeWidth=0)
        )
        return g
    ...
    def _Flag_Luxembourg(self):
        ...
        bluebox = Rect(
            0, 0, width=s * 2.0, height=s / 3.0, fillColor=colors.dodgerblue, strokeColor=None, strokeWidth=0
        )
        g.add(bluebox)
        return g
    ...
    def _Flag_Norway(self):
        ...
        whiteline1 = Rect(
            ((s * 0.2) * 2), 0, width=s * 0.2, height=s, fillColor=colors.ghostwhite, strokeColor=None, strokeWidth=0
        )
        g.add(whiteline1)
        ...
        blueline1 = Rect(
            ((s * 0.225) * 2), 0, width=0.1 * s, height=s, fillColor=colors.darkblue, strokeColor=None, strokeWidth=0
        )
        g.add(blueline1)

        blueline2 = Rect(
            0, (s * 0.45), width=self._width, height=s * 0.1, fillColor=colors.darkblue, strokeColor=None, strokeWidth=0
        )
        g.add(blueline2)
        return g
    ...
    def _Flag_CzechRepublic(self):
        ...
        bluewedge = Polygon(
            points=[0, 0, s, (s / 2.0), 0, s], fillColor=colors.darkblue, strokeColor=None, strokeWidth=0
        )
        g.add(bluewedge)
        return g
    ...
    def _Flag_Palestine(self):
        ...
        blackbox = Rect(
            0, 2 * s / 3.0, width=s * 2, height=s / 3.0, fillColor=colors.black, strokeColor=None, strokeWidth=0
        )
        g.add(blackbox)

        redwedge = Polygon(
            points=[0, 0, 2 * s / 3.0, (s / 2.0), 0, s], fillColor=colors.red, strokeColor=None, strokeWidth=0
        )
        g.add(redwedge)
        return g
    ...
    def _Flag_Turkey(self):
        ...
        whitecircle = Circle(
            cx=((s * 0.35) * 2), cy=s / 2.0, r=s * 0.3, fillColor=colors.mintcream, strokeColor=None, strokeWidth=0
        )
        g.add(whitecircle)

        redcircle = Circle(
            cx=((s * 0.39) * 2), cy=s / 2.0, r=s * 0.24, fillColor=colors.red, strokeColor=None, strokeWidth=0
        )
        g.add(redcircle)
    ...
    def _Flag_Brazil(self):
        ...
        g.add(
            Polygon(
                points=[1.7 * m, (s / 2.0), (w / 2.0), s - (1.7 * m), w - (1.7 * m), (s / 2.0), (w / 2.0), 1.7 * m],
        ...
        g.add(
            Wedge(
                (w / 2.0) - (2 * m), 0, 8 * m, 48.1, 100, 8 * m, fillColor=colors.blue, strokeColor=None, strokeWidth=0
            )
        )
        ...
        for i in range(nTmp):
            ...
            if i == 6:
                ...
                z = 0.45 * m
            g2 = Group(
                String(x, y, sTmp[i], fontName="Helvetica-Bold", fontSize=z, strokeColor=None, fillColor=colors.green)
            )
            g2.rotate(rad)
            g.add(g2)
        return g
