...
from reportlab.graphics.renderbase import STATE_DEFAULTS, Renderer, getStateDelta, renderScaledDrawing
    ...
    def drawRect(self, rect):
        if rect.rx == rect.ry == 0:
            ...
            self._canvas.roundRect(
                rect.x, rect.y, rect.width, rect.height, rect.rx, fill=self._fill, stroke=self._stroke
            )
    ...
    def drawWedge(self, wedge):
        if wedge.annular:
            ...
            if (radius1 == 0 or radius1 is None) and (yradius1 == 0 or yradius1 is None):
                ...
                path.arcTo(
                    centerx - radius, centery - yradius, centerx + radius, centery + yradius, startangledegrees, angle
                )
            else:
                path.arc(
                    centerx - radius, centery - yradius, centerx + radius, centery + yradius, startangledegrees, angle
