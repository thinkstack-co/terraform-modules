...
| <a name="input_bucket_prefix"></a> [bucket_prefix](#input_bucket_prefix)                                                          | (Optional, Forces new resource) Creates a unique bucket name beginning with the specified prefix. Conflicts with bucket.                                                                                                                                                                                                                                                                              | `string`   | n/a                                                                                                                                                                                                                                        |   yes    |
| <a name="input_cloudwatch_name_prefix"></a> [cloudwatch_name_prefix](#input_cloudwatch_name_prefix)                               | (Optional, Forces new resource) Creates a unique name beginning with the specified prefix.                                                                                                                                                                                                                                                                                                            | `string`   | `"cloudtrail_"`                                                                                                                                                                                                                            |    no    |
...
| <a name="input_enable_bucket_lifecycle"></a> [enable_bucket_lifecycle](#input_enable_bucket_lifecycle)                           | (Optional) Whether to create the lifecycle configuration on the CloudTrail S3 bucket. Consumed by aws_s3_bucket_lifecycle_configuration.cloudtrail_bucket_lifecycle. Defaults true.                                                                                                                                                                                                                    | `bool`     | `true`                                                                                                                                                                                                                                     |    no    |
| <a name="input_enable_cloudwatch_logs"></a> [enable_cloudwatch_logs](#input_enable_cloudwatch_logs)                               | (Optional) Whether to deliver CloudTrail events to a CloudWatch log group (with its IAM role/policy and KMS grant) for near-real-time metric filters and alarms. The S3 trail is unaffected either way. Defaults true.                                                                                                                                                                                  | `bool`     | `true`                                                                                                                                                                                                                                     |    no    |
...
| <a name="input_expected_bucket_owner"></a> [expected_bucket_owner](#input_expected_bucket_owner)                                  | (Optional, Forces new resource) Account ID of the expected bucket owner.                                                                                                                                                                                                                                                                                                                              | `string`   | `""`                                                                                                                                                                                                                                       |    no    |
...
| <a name="input_key_name_prefix"></a> [key_name_prefix](#input_key_name_prefix)                                                    | (Optional) Creates an unique alias beginning with the specified prefix. The name must start with the word alias followed by a forward slash (alias/).                                                                                                                                                                                                                                                 | `string`   | `"alias/cloudtrail_key_"`                                                                                                                                                                                                                  |    no    |
...
| <a name="input_s3_key_prefix"></a> [s3_key_prefix](#input_s3_key_prefix)                                                          | S3 key prefix to be applied to all logs                                                                                                                                                                                                                                                                                                                                                               | `string`   | `"cloudtrail-logs"`                                                                                                                                                                                                                        |    no    |
