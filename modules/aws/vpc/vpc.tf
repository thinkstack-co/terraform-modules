...
resource "aws_subnet" "private_subnets" {
  ...
  tags              = "${merge(var.tags, tomap("Name", format("%s-subnet-private-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "public_subnets" {
  ...
  tags                    = "${merge(var.tags, tomap("Name", format("%s-subnet-public-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "dmz_subnets" {
  ...
  tags              = "${merge(var.tags, tomap("Name", format("%s-subnet-dmz-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "db_subnets" {
  ...
  tags              = "${merge(var.tags, tomap("Name", format("%s-subnet-db-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "mgmt_subnets" {
  ...
  tags              = "${merge(var.tags, tomap("Name", format("%s-subnet-mgmt-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "workspaces_subnets" {
  ...
  tags              = "${merge(var.tags, tomap("Name", format("%s-subnet-workspaces-%s", var.name, element(var.azs, count.index))))}"
}
...
resource "aws_route_table" "db_route_table" {
  ...
  tags             = "${merge(var.tags, tomap("Name", format("%s-rt-db-%s", var.name, element(var.azs, count.index))))}"
  vpc_id           = "${aws_vpc.vpc.id}"
}
...
resource "aws_route_table" "dmz_route_table" {
  ...
  tags             = "${merge(var.tags, tomap("Name", format("%s-rt-dmz-%s", var.name, element(var.azs, count.index))))}"
  vpc_id           = "${aws_vpc.vpc.id}"
}
...
resource "aws_route_table" "mgmt_route_table" {
  ...
  tags             = "${merge(var.tags, tomap("Name", format("%s-rt-mgmt-%s", var.name, element(var.azs, count.index))))}"
  vpc_id           = "${aws_vpc.vpc.id}"
}
...
resource "aws_route_table" "workspaces_route_table" {
  ...
  tags             = "${merge(var.tags, tomap("Name", format("%s-rt-workspaces-%s", var.name, element(var.azs, count.index))))}"
  vpc_id           = "${aws_vpc.vpc.id}"
}
