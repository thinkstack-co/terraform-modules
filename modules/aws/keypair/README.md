...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | ----- | ------- | :------: |
| <a name="input_key_name_prefix"></a> [key_name_prefix](#input_key_name_prefix) | SSL key pair name prefix, used to generate unique keypair name for EC2 instance deployments | `any` | n/a     |   yes    |
| <a name="input_public_key"></a> [public_key](#input_public_key)                | Public rsa key                                                                              | `any` | n/a     |   yes    |
