...
```hcl
module "linux_vm" {
  source = "github.com/thinkstack-co/terraform-modules//modules/azure/terraform_modules/compute/vm"
...
- `source_image_id` - (Optional) The ID of a custom image to use. If provided, source*image*\* variables are ignored.
