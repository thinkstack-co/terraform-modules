...
| <a name="input_azs"></a> [azs](#input\_azs) | A list of availability zones in the region which will be utilized by this VPC | `list` | <pre>[<br>  "us-east-1a",<br>  "us-east-1b"<br>]</pre> | no |
...
| <a name="input_created_by"></a> [created\_by](#input\_created\_by) | (Required) the full name of the person who is created the resource in terraform | `string` | n/a | yes |
...
| <a name="input_encrypted"></a> [encrypted](#input\_encrypted) | (Optional) Enable volume encryption. (Default: false). Must be configured to perform drift detection. | `string` | `true` | no |
...
| <a name="input_private_subnets_list"></a> [private\_subnets\_list](#input\_private\_subnets\_list) | A list of private subnets inside the VPC. | `list` | <pre>[<br>  "10.77.1.64/26",<br>  "10.77.1.192/26"<br>]</pre> | no |
| <a name="input_public_key"></a> [public\_key](#input\_public\_key) | (Required) Public rsa key | `any` | n/a | yes |
...
| <a name="input_public_subnets_list"></a> [public\_subnets\_list](#input\_public\_subnets\_list) | A list of public subnets inside the VPC. | `list` | <pre>[<br>  "10.77.1.0/26",<br>  "10.77.1.128/26"<br>]</pre> | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | A map of tags to add to all resources | `map` | <pre>{<br>  "backup": "true",<br>  "created_by": "Your Name",<br>  "environment": "prod",<br>  "project": "SIEM Implementation",<br>  "service": "soc",<br>  "team": "Security Team",<br>  "terraform": "true",<br>  "used_by": "ThinkStack"<br>}</pre> | no |
