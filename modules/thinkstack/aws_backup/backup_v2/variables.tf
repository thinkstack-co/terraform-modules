...
variable "schedule" {
  description = "A CRON expression specifying when to initiate backups"
  type        = string
}

variable "cold_storage_after_days" {
  description = "The number of days after creation when a recovery point is moved to cold storage."
  type        = number
}

variable "delete_after_days" {
  description = "The number of days after creation when a recovery point is deleted."
  type        = number
}
